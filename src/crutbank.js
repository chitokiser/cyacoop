      ...
      const contractAddress = {
        ...
        cyabankAddr:"0xbfe3Aa8f50D4a857aE43556CB60E90F2aaa41A25" //cRutbank
   }
  ...
  let Buymut = async () => {
    ...
    try {
      await cyabankContract.buycrut(document.getElementById('buyAmount').value);
    } catch(e) {
      alert(e.data.message.replace('execution reverted: ',''))
    }
  };
  ...
  let Sellmut = async () => {
    ...
    try {
      await cyabankContract.sellcrut(document.getElementById('sellAmount').value);
    } catch(e) {
      alert(e.data.message.replace('execution reverted: ',''))
    }
  };
