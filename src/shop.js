document.addEventListener("DOMContentLoaded", function () {
    let metaddr = {
        metmarket: "0x4Ea6FCc6912C62A34131863aeB2C7223fa5a1EF1" //shop
    };
    ...
    let metabi = {
        metmarket: [
            ...
            "function metainfo(uint _num) public view returns (string memory,string memory,string memory,uint256,uint256,uint256,uint256)",
                        ...
                        <div class="card mb-3" id="productCard${i}">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>남은 수량:</strong> ${metaInfo.info3}개</p>
                                 ...
                                 <p class="card-text"><strong>CUT제공개수:</strong> ${metaInfo.info5}CUT</p>
                                <p class="card-text"><strong>가격:</strong> ${metaInfo.info6/1e18}CYA</p>
